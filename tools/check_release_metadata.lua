...
PZLinuxReleaseAssert(readme:find("%*%*Release:%*%* 1%.0%.13"), "README release is not 1.0.13")
...
PZLinuxReleaseAssert(versionFile:match("^1%.0%.13%s*$"), "version file is not 1.0.13")
PZLinuxReleaseAssert(overview:find("^version=1%.0%.13"), "overview release is not 1.0.13")
PZLinuxReleaseAssert(releaseNotes:find("^%[h1%]PZLinux 1%.0%.13%[/h1%]"), "release notes are not 1.0.13")
PZLinuxReleaseAssert(workshop:find("^version=1\n"), "workshop format version must remain 1")
PZLinuxReleaseAssert(workshop:find("PZLinux 1%.0%.13"), "Workshop description is not 1.0.13")
PZLinuxReleaseAssert(workshop:find("\nvisibility=0\n?$"), "Workshop visibility must use public value 0")
PZLinuxReleaseAssert(modInfo:find("\nmodversion=1%.0%.13\n"), "mod.info has no 1.0.13 modversion")
PZLinuxReleaseAssert(modInfo:find("\nversionMin=42%.20\n"), "mod.info has no Build 42.20 minimum")
PZLinuxReleaseAssert(modInfo:find("\nid=B42_PZLinux\n"), "stable mod ID changed")
PZLinuxReleaseAssert(linuxMenu:find('local PZLinuxVersion = "v1%.0%.13"'), "terminal UI version is not 1.0.13")
...
print("PZLinux release metadata OK: v1.0.13, Build 42.20+, Workshop format 1")
