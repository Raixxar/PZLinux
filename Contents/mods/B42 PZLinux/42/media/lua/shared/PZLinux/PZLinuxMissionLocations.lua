...
PZLinux.MissionLocations.pools.packages = PZLinux.MissionLocations.pools.packages or {
    byCityId = {
        [1] = {
            ...
            { id = "pkg_irvington_1st_ave_01", description = "At 1st Ave, in Irvington.", x = 2506, y = 14044, z = 1, city = "Irvington", building = "1st Ave", tags = { "package" }, enabled = true },
            { id = "pkg_irvington_hall_road_01", description = "At Hall Road, in Irvington.", x = 2447, y = 14077, z = 1, city = "Irvington", building = "Hall Road", tags = { "package" }, enabled = true },
            { id = "pkg_irvington_1st_ave_02", description = "At 1st Ave, in Irvington.", x = 2468, y = 14053, z = 1, city = "Irvington", building = "1st Ave", tags = { "package" }, enabled = true },
        },
        [2] = {
            { id = "pkg_ekron_railway_st_01", description = "At Railway St, in Ekron.", x = 606, y = 9840, z = 1, city = "Ekron", building = "Railway St", tags = { "package" }, enabled = true },
            { id = "pkg_ekron_berry_dr_01", description = "At Berry Dr, in Ekron.", x = 763, y = 9764, z = 1, city = "Ekron", building = "Berry Dr", tags = { "package" }, enabled = true },
            { id = "pkg_ekron_parkway_ave_01", description = "At Parkway Ave, in Ekron.", x = 743, y = 9837, z = 2, city = "Ekron", building = "Parkway Ave", tags = { "package" }, enabled = true },
        },
        [3] = {
        ...
        [4] = {
            ...
            { id = "pkg_echo_creek_payne_road_01", description = "At Payne Road, in Echo Creek.", x = 3684, y = 10891, z = 1, city = "Echo Creek", building = "Payne Road", tags = { "package" }, enabled = true },
            { id = "pkg_echo_creek_creek_lane_01", description = "At Creek Lane, in Echo Creek.", x = 3390, y = 11080, z = 1, city = "Echo Creek", building = "Creek Lane", tags = { "package" }, enabled = true },
        },
        [5] = {
            { id = "pkg_riverside_maria_pl_01", description = "At Maria Pl, in Riverside.", x = 6451, y = 5252, z = 2, city = "Riverside", building = "Maria Pl", tags = { "package" }, enabled = true },
            { id = "pkg_riverside_pitts_st_01", description = "At Pitts St, in Riverside.", x = 6502, y = 5419, z = 2, city = "Riverside", building = "Pitts St", tags = { "package" }, enabled = true },
            { id = "pkg_riverside_e_main_st_01", description = "At E Main St, in Riverside.", x = 6654, y = 5249, z = 2, city = "Riverside", building = "E Main St", tags = { "package" }, enabled = true },
            { id = "pkg_riverside_harbor_st_01", description = "At Harbor St, in Riverside.", x = 6217, y = 5346, z = 1, city = "Riverside", building = "Harbor St", tags = { "package" }, enabled = true },
            { id = "pkg_riverside_w_main_st_01", description = "At W Main St, in Riverside.", x = 6085, y = 5221, z = 1, city = "Riverside", building = "W Main St", tags = { "package" }, enabled = true },
        },
        [6] = {},
        [7] = {
            ...
            { id = "pkg_rosewood_frederick_lane_01", description = "At Frederick Lane, in Rosewood.", x = 8067, y = 11609, z = 2, city = "Rosewood", building = "Frederick Lane", tags = { "package" }, enabled = true },
            { id = "pkg_rosewood_north_main_st_01", description = "At North Main St, in Rosewood.", x = 8121, y = 11552, z = 2, city = "Rosewood", building = "North Main St", tags = { "package" }, enabled = true },
        },
        [8] = {
        ...
        [9] = {
            ...
            { id = "pkg_muldraugh_harris_court_01", description = "At Harris Court, in Muldraugh.", x = 10746, y = 9546, z = 1, city = "Muldraugh", building = "Harris Court", tags = { "package" }, enabled = true },
            { id = "pkg_muldraugh_bank_road_01", description = "At Bank Road, in Muldraugh.", x = 10631, y = 9695, z = -1, city = "Muldraugh", building = "Bank Road", tags = { "package" }, enabled = true },
            { id = "pkg_muldraugh_wilson_st_01", description = "At Wilson St, in Muldraugh.", x = 10642, y = 10397, z = -1, city = "Muldraugh", building = "Wilson St", tags = { "package" }, enabled = true },
            { id = "pkg_muldraugh_perrine_st_01", description = "At Perrine St, in Muldraugh.", x = 10721, y = 10414, z = 1, city = "Muldraugh", building = "Perrine St", tags = { "package" }, enabled = true },
        },
        [10] = {
            ...
            { id = "pkg_west_point_main_st_01", description = "At Main St, in West Point.", x = 11955, y = 6901, z = 2, city = "West Point", building = "Main St", tags = { "package" }, enabled = true },
            { id = "pkg_west_point_main_st_02", description = "At Main St, in West Point.", x = 11829, y = 6907, z = 1, city = "West Point", building = "Main St", tags = { "package" }, enabled = true },
            { id = "pkg_west_point_church_st_01", description = "At Church St, in West Point.", x = 11978, y = 6946, z = 1, city = "West Point", building = "Church St", tags = { "package" }, enabled = true },
            { id = "pkg_west_point_2nd_st_01", description = "At 2nd St, in West Point.", x = 12141, y = 7076, z = 1, city = "West Point", building = "2nd St", tags = { "package" }, enabled = true },
        },
        [11] = {},
        [12] = {
            ...
            { id = "pkg_louisville_fresno_st_01", description = "At Fresno St, in Louisville.", x = 12735, y = 1581, z = 10, city = "Louisville", building = "Fresno St", tags = { "package" }, enabled = true },
            { id = "pkg_louisville_w_main_st_01", description = "At W Main St, in Louisville.", x = 12665, y = 1491, z = 10, city = "Louisville", building = "W Main St", tags = { "package" }, enabled = true },
            { id = "pkg_louisville_san_francisco_st_01", description = "At San Francisco St, in Louisville.", x = 12691, y = 1449, z = 23, city = "Louisville", building = "San Francisco St", tags = { "package" }, enabled = true },
            { id = "pkg_louisville_ponderosa_st_01", description = "At Ponderosa St, in Louisville.", x = 12756, y = 1587, z = 7, city = "Louisville", building = "Ponderosa St", tags = { "package" }, enabled = true },
            { id = "pkg_louisville_w_main_st_02", description = "At W Main St, in Louisville.", x = 12690, y = 1499, z = 4, city = "Louisville", building = "W Main St", tags = { "package" }, enabled = true },
            { id = "pkg_louisville_n_1st_st_01", description = "At N 1st St, in Louisville.", x = 12600, y = 2014, z = 4, city = "Louisville", building = "N 1st St", tags = { "package" }, enabled = true },
            { id = "pkg_louisville_new_hunter_st_01", description = "At New Hunter St, in Louisville.", x = 13566, y = 1689, z = 4, city = "Louisville", building = "New Hunter St", tags = { "package" }, enabled = true },
        },
        [13] = {
...
PZLinux.MissionLocations.pools.protect = PZLinux.MissionLocations.pools.protect or {
    byCityId = {
        [1] = {
            { id = "protect_irvington_1st_ave_01", description = "Protect the building near 1st Ave in Irvington.", x = 2526, y = 14471, z = 0, city = "Irvington", street = "1st Ave", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_irvington_merino_st_01", description = "Protect the building near Merino St in Irvington.", x = 2264, y = 14361, z = 0, city = "Irvington", street = "Merino St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_irvington_1st_ave_02", description = "Protect the building near 1st Ave in Irvington.", x = 2476, y = 14064, z = 0, city = "Irvington", street = "1st Ave", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [2] = {
            ...
            { id = "protect_ekron_east_alley_st_01", description = "Protect the building near East Alley St in Ekron.", x = 434, y = 9862, z = 0, city = "Ekron", street = "East Alley St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_ekron_western_railroad_01", description = "Protect the building near Western Railroad in Ekron.", x = 567, y = 9700, z = 0, city = "Ekron", street = "Western Railroad", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_ekron_western_railroad_02", description = "Protect the building near Western Railroad in Ekron.", x = 579, y = 9427, z = 0, city = "Ekron", street = "Western Railroad", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [3] = {
            ...
            { id = "protect_brandenburg_boyd_road_03", description = "Protect the building near Boyd Road in Brandenburg.", x = 2068, y = 6282, z = 0, city = "Brandenburg", street = "Boyd Road", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_brandenburg_kelly_dr_01", description = "Protect the building near Kelly Dr in Brandenburg.", x = 2081, y = 5829, z = 0, city = "Brandenburg", street = "Kelly Dr", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_brandenburg_river_front_park_01", description = "Protect the building near River Front Park in Brandenburg.", x = 2045, y = 5690, z = 0, city = "Brandenburg", street = "River Front Park", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_brandenburg_boyd_road_04", description = "Protect the building near Boyd Road in Brandenburg.", x = 2044, y = 5971, z = 0, city = "Brandenburg", street = "Boyd Road", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [4] = {},
        [5] = {
            ...
            { id = "protect_riverside_e_main_st_01", description = "Protect the building near E Main St in Riverside.", x = 6512, y = 5297, z = 0, city = "Riverside", street = "E Main St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_riverside_w_main_st_02", description = "Protect the building near W Main St in Riverside.", x = 6077, y = 5304, z = 0, city = "Riverside", street = "W Main St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_riverside_w_main_st_03", description = "Protect the building near W Main St in Riverside.", x = 6131, y = 5255, z = 0, city = "Riverside", street = "W Main St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_riverside_e_main_st_02", description = "Protect the building near E Main St in Riverside.", x = 6657, y = 5247, z = 0, city = "Riverside", street = "E Main St", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [6] = {
            { id = "protect_fallas_lake_main_st_01", description = "Protect the building near Main St in Fallas Lake.", x = 7251, y = 8323, z = 0, city = "Fallas Lake", street = "Main St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_fallas_lake_main_st_02", description = "Protect the building near Main St in Fallas Lake.", x = 7288, y = 8345, z = 0, city = "Fallas Lake", street = "Main St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_fallas_lake_railview_road_01", description = "Protect the building near Railview Road in Fallas Lake.", x = 7312, y = 8179, z = 0, city = "Fallas Lake", street = "Railview Road", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [7] = {
            { id = "protect_rosewood_north_main_st_01", description = "Protect the building near North Main St in Rosewood.", x = 8077, y = 11658, z = 0, city = "Rosewood", street = "North Main St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_rosewood_quiet_st_01", description = "Protect the building near Quiet St in Rosewood.", x = 8043, y = 11463, z = 0, city = "Rosewood", street = "Quiet St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_rosewood_denton_st_01", description = "Protect the building near Denton St in Rosewood.", x = 8137, y = 11297, z = 0, city = "Rosewood", street = "Denton St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_rosewood_denton_st_02", description = "Protect the building near Denton St in Rosewood.", x = 8261, y = 11243, z = 0, city = "Rosewood", street = "Denton St", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [8] = {
            { id = "protect_march_ridge_piers_av_01", description = "Protect the building near Piers Av in March Ridge.", x = 10143, y = 12756, z = 0, city = "March Ridge", street = "Piers Av", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_march_ridge_piers_av_02", description = "Protect the building near Piers Av in March Ridge.", x = 10141, y = 12785, z = 0, city = "March Ridge", street = "Piers Av", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [9] = {
            { id = "protect_muldraugh_wilson_st_01", description = "Protect the building near Wilson St in Muldraugh.", x = 10610, y = 10217, z = 0, city = "Muldraugh", street = "Wilson St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_muldraugh_wilson_st_02", description = "Protect the building near Wilson St in Muldraugh.", x = 10610, y = 10452, z = 0, city = "Muldraugh", street = "Wilson St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_muldraugh_n_main_st_01", description = "Protect the building near N Main St in Muldraugh.", x = 10617, y = 9312, z = 0, city = "Muldraugh", street = "N Main St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_muldraugh_old_bank_road_01", description = "Protect the building near Old Bank Road in Muldraugh.", x = 10622, y = 9218, z = 0, city = "Muldraugh", street = "Old Bank Road", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_muldraugh_old_loop_road_01", description = "Protect the building near Old Loop Road in Muldraugh.", x = 10812, y = 10412, z = 0, city = "Muldraugh", street = "Old Loop Road", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_muldraugh_dixie_highway_01", description = "Protect the building near Dixie Highway in Muldraugh.", x = 10616, y = 10560, z = 0, city = "Muldraugh", street = "Dixie Highway", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [10] = {
            { id = "protect_west_point_mulberry_st_01", description = "Protect the building near Mulberry St in West Point.", x = 11882, y = 6863, z = 0, city = "West Point", street = "Mulberry St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_west_point_oak_st_01", description = "Protect the building near Oak St in West Point.", x = 11342, y = 6779, z = 0, city = "West Point", street = "Oak St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_west_point_northern_railroad_01", description = "Protect the building near Northern Railroad in West Point.", x = 12163, y = 6940, z = 0, city = "West Point", street = "Northern Railroad", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [11] = {},
        [12] = {
            { id = "protect_louisville_n_1st_st_01", description = "Protect the building near N 1st St in Louisville.", x = 12616, y = 2080, z = 0, city = "Louisville", street = "N 1st St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_louisville_jefferson_st_01", description = "Protect the building near Jefferson St in Louisville.", x = 12522, y = 1484, z = 0, city = "Louisville", street = "Jefferson St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_louisville_new_york_st_01", description = "Protect the building near New York St in Louisville.", x = 12821, y = 1315, z = 0, city = "Louisville", street = "New York St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_louisville_goat_race_alley_01", description = "Protect the building near Goat Race Alley in Louisville.", x = 13592, y = 1533, z = 0, city = "Louisville", street = "Goat Race Alley", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_louisville_n_1st_st_02", description = "Protect the building near N 1st St in Louisville.", x = 12627, y = 1707, z = 0, city = "Louisville", street = "N 1st St", tags = { "protect", "horde", "building" }, enabled = true },
            { id = "protect_louisville_legiron_st_01", description = "Protect the building near Legiron St in Louisville.", x = 12479, y = 1607, z = 0, city = "Louisville", street = "Legiron St", tags = { "protect", "horde", "building" }, enabled = true },
        },
        [13] = {},
    },
}
...
PZLinux.MissionLocations.pools.atmRefill = PZLinux.MissionLocations.pools.atmRefill or {
    byCityId = {
        ...
        [3] = {
            { id = "atm_brandenburg_knox_bank_01", description = "At the Knox Bank ATM in Brandenburg.", x = 2079, y = 5836, z = 0, city = "Brandenburg", building = "Knox Bank", tags = { "atm", "bank" }, enabled = true },
        },
        [4] = {},
        [5] = {},
        [6] = {},
        ...
        [8] = {},
        [9] = {
            { id = "atm_muldraugh_corner_store_01", description = "At the Corner Store ATM in Muldraugh.", x = 10850, y = 10033, z = 0, city = "Muldraugh", building = "Corner Store", tags = { "atm", "store" }, enabled = true },
        },
        [10] = {},
        [11] = {
            { id = "atm_valleystation_knox_bank_01", description = "At the Knox Bank ATM in Valley Station.", x = 13665, y = 5751, z = 0, city = "Valley Station", building = "Knox Bank", tags = { "atm", "bank" }, enabled = true },
        },
        [12] = {
            { id = "atm_louisville_knox_bank_01", description = "At the Knox Bank ATM in Louisville.", x = 12585, y = 1715, z = 0, city = "Louisville", building = "Knox Bank", tags = { "atm", "bank" }, enabled = true },
        },
        [13] = {},
    },
}
