...
PZLinux.MissionLocations.pools.manhunt = PZLinux.MissionLocations.pools.manhunt or {
    byCityId = {
        [1] = {
            { id = "target_irvington_old_church_st_01", description = "The target was last seen near Old Church St in Irvington.", x = 2825, y = 13802, z = 0, city = "Irvington", street = "Old Church St", tags = { "target", "zombie_spawn", "street" }, enabled = true },
        },
        [2] = {},
        [3] = {
            { id = "target_brandenburg_river_front_park_01", description = "The target was last seen near River Front Park in Brandenburg.", x = 2025, y = 5682, z = 0, city = "Brandenburg", street = "River Front Park", tags = { "target", "zombie_spawn", "park" }, enabled = true },
            { id = "target_brandenburg_n_brand_st_01", description = "The target was last seen near N Brand St in Brandenburg.", x = 1642, y = 5576, z = 0, city = "Brandenburg", street = "N Brand St", tags = { "target", "zombie_spawn", "street" }, enabled = true },
        },
        [4] = {},
        [5] = {
            { id = "target_riverside_maria_pl_01", description = "The target was last seen near Maria Pl in Riverside.", x = 6333, y = 5198, z = 0, city = "Riverside", street = "Maria Pl", tags = { "target", "zombie_spawn", "street" }, enabled = true },
            { id = "target_riverside_maria_pl_02", description = "The target was last seen near Maria Pl in Riverside.", x = 6378, y = 5138, z = 0, city = "Riverside", street = "Maria Pl", tags = { "target", "zombie_spawn", "street" }, enabled = true },
            { id = "target_riverside_e_main_st_01", description = "The target was last seen near E Main St in Riverside.", x = 6825, y = 5257, z = 0, city = "Riverside", street = "E Main St", tags = { "target", "zombie_spawn", "street" }, enabled = true },
            { id = "target_riverside_walnut_st_01", description = "The target was last seen near Walnut St in Riverside.", x = 5929, y = 5364, z = 0, city = "Riverside", street = "Walnut St", tags = { "target", "zombie_spawn", "street" }, enabled = true },
            { id = "target_riverside_rag_road_01", description = "The target was last seen near Rag Road in Riverside.", x = 5785, y = 5379, z = 0, city = "Riverside", street = "Rag Road", tags = { "target", "zombie_spawn", "road" }, enabled = true },
        },
        [6] = {},
        [7] = {
            { id = "target_rosewood_frederick_lane_01", description = "The target was last seen near Frederick Lane in Rosewood.", x = 8351, y = 11528, z = 0, city = "Rosewood", street = "Frederick Lane", tags = { "target", "zombie_spawn", "street" }, enabled = true },
            { id = "target_rosewood_horselick_road_01", description = "The target was last seen near Horselick Road outside Rosewood.", x = 7436, y = 11876, z = 0, city = "Rosewood", street = "Horselick Road", tags = { "target", "zombie_spawn", "remote" }, enabled = true },
            { id = "target_rosewood_yew_road_01", description = "The target was last seen near Yew Road in Rosewood.", x = 8801, y = 11603, z = 0, city = "Rosewood", street = "Yew Road", tags = { "target", "zombie_spawn", "road" }, enabled = true },
        },
        [8] = {},
        [9] = {
        ...
        [10] = {
            { id = "target_west_point_7th_st_01", description = "The target was last seen near 7th St in West Point.", x = 11737, y = 6978, z = 0, city = "West Point", street = "7th St", tags = { "target", "zombie_spawn", "street" }, enabled = true },
            { id = "target_west_point_oak_st_01", description = "The target was last seen near Oak St in West Point.", x = 11075, y = 6692, z = 0, city = "West Point", street = "Oak St", tags = { "target", "zombie_spawn", "street" }, enabled = true },
        },
        [11] = {},
        [12] = {
            { id = "target_louisville_e_river_road_01", description = "The target was last seen near E River Road in Louisville.", x = 12983, y = 1133, z = 0, city = "Louisville", street = "E River Road", tags = { "target", "zombie_spawn", "road" }, enabled = true },
            { id = "target_louisville_bourbon_way_01", description = "The target was last seen near Bourbon Way in Louisville.", x = 11990, y = 1662, z = 0, city = "Louisville", street = "Bourbon Way", tags = { "target", "zombie_spawn", "street" }, enabled = true },
        },
        [13] = {},
    },
}
