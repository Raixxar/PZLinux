...
PZLinuxRequestDefinitions = PZLinuxRequestDefinitions or {
    ...
    [11] = { baseName = "Materials", price = 650, defaultWeight = 0.1, itemWeights = { ["Base.ConcretePowder"] = 5, ["Base.PlasterPowder"] = 5, ["Base.BarbedWire"] = 1, ["Base.NailsBox"] = 0.3, ["Base.PaperclipBox"] = 0.3, ["Base.Screws"] = 0.3, ["Base.Sparklers"] = 0.2, ["Base.Charcoal"] = 8, ["Base.Dirtbag"] = 2, ["Base.Hinge"] = 0.3, ["Base.Doorknob"] = 0.5, ["Base.Gravelbag"] = 2, ["Base.SheetMetal"] = 1.5, ["Base.Nails"] = 0.01, ["Base.Plank"] = 3, ["Base.PropaneTank"] = 10, ["Base.Rope"] = 0.8, ["Base.SmallSheetMetal"] = 0.4, ["Base.Stone"] = 1, ["Base.Tarp"] = 1, ["Base.WeldingRods"] = 1.5, ["Base.Wire"] = 0.2, ["Base.DenimStrips"] = 0.05, ["Base.LeatherStrips"] = 0.05, ["Base.RippedSheets"] = 0.05 }, items = {"Base.Aluminum", "Base.ConcretePowder", "Base.PlasterPowder", "Base.BarbedWire", "Base.NailsBox", "Base.PaperclipBox", "Base.Screws", "Base.Sparklers", "Base.Charcoal", "Base.Dirtbag", "Base.Hinge", "Base.Doorknob", "Base.Gravelbag", "Base.GunPowder", "Base.SheetMetal", "Base.Nails", "Base.Plank", "Base.PropaneTank", "Base.Rope", "Base.SmallSheetMetal", "Base.Staples", "Base.Stone", "Base.Tarp", "Base.Thread", "Base.Twine", "Base.WeldingRods", "Base.Wire", "Base.Yarn", "Base.DenimStrips", "Base.LeatherStrips", "Base.RippedSheets"} },
